...
class User:
    ...
    @classmethod
    def save(cls,data):
        query = "INSERT INTO user (first_name, last_name, age, email, password, location, about_me, goal, profile_picture) VALUES (%(first_name)s, %(last_name)s, %(age)s, %(email)s, %(password)s, %(location)s, %(about_me)s, %(goal)s, %(profile_picture)s)"
